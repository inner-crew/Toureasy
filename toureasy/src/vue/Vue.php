...
END;
        ...
        if (sizeof($monumentsDeUtilisateur) > 0) {
            $html .= <<<END
<form method="post">
<select class="ml-10" name="monuments" id="monument-selected">
...
END;
 ...
 <input type="submit" name="action" value="OK" class="group relative ml-10 mt-10 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                </input>
 </form>
 END;
        }
